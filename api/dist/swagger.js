        ...
        paths: {
            ...
            "/payments/midtrans/notification": {
                post: {
                    ...
                    description: "Endpoint publik yang dipanggil Midtrans. Untuk testing via Swagger, isi signature_key dengan SHA512(order_id + status_code + gross_amount + MIDTRANS_SERVER_KEY).",
                    requestBody: {
                        required: true,
                        content: {
                            "application/json": {
